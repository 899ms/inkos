...
const strings = {
  ...
  "analytics.observations": { zh: "观察记录", en: "Observations" },
  "analytics.runtimeEvidence": { zh: "运行证据", en: "Runtime Evidence" },
  "analytics.chaptersWithObservations": { zh: "有观察的章节", en: "Chapters with Observations" },
  ...
  "book.audit": { zh: "审查", en: "Review" },
  "book.review": { zh: "审查观察", en: "Review" },
  "book.observations": { zh: "条观察", en: "observations" },
  "book.currentRevision": { zh: "当前版本", en: "Current revision" },
  ...
  "settings.detectionHint": { zh: "配置外部 AIGC 检测服务与观察阈值；关闭即不配置检测。", en: "Configure an external AIGC detection service and observation threshold; turn off to clear it." },
